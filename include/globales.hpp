...
*/
// los pines 4 y 5 seran de la pantalla OLED
#define RELAY1 6      // GPIO04 para el relay   salida
#define RELAY2 35     // GPIO02 para el relay   salida
#define DIMMER 36     // GPIO05 para el dimmer salida del PWM salida
#define WIFILED 1     // GPIO12 LED INDICADOR WIFI salida
#define MQTTLED 47    // GPIO14 LED INDICADOR MQTT salida
#define BUZZER 38     // GPIO40 ZUMBADOR    salida
#define ALARM_PIN1 45 // GPIO16 entrada de alarma con tierra  ----RX2 entrada
#define ALARM_PIN2 39 // GPIO17 entrada de alarma con tierra  ----TX2 entrada
#define TMOSFET2 3    // GPIO19 Salida que alimenta a un MOSFET salida
#define TMOSFET1 2    // GPIO23 Salida que alimenta a un MOSFET salida
#define ALARM_PIN3 40 // GPIO25 entrada de alarma con tierra  ----D25 entrada
#define CLIMAA 42     // GPIO26 entrada con acoplador a 5-24 volts indicarian si sigue operando un compresor1
#define CLIMAB 41     // GPIO27 entrada con acoplador a 5-24 volts indicarian si sigue operando un compresor2
#define PINREST 14    // pin de reinicio y restauracion entrada
#define ACTRELE1 37   // Botón de interrupción para relevador2 entrada
#define ACTFECHA 11   // para actualizar la fecha entrada
#define ACTRELE2 10   // Botón de interrupción para relevador2 entrada
#define INPOT 7       // *entrada del valor del potenciometro entrada
#define INAC 21       // Pin de Entrada de Corriente alterna para el dimer entrada
#define DHTPIN 12     // entrada del dht22
//--------------------------------------------------------
